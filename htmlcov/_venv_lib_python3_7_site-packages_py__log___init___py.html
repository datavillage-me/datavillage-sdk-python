...
<head>
    ...
    <title>Coverage for .venv/lib/python3.7/site-packages/py/_log/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.venv/lib/python3.7/site-packages/py/_log/__init__.py</b> :
...
<div id="source">
    <p id="t1" class="pln"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="str">""" logging API ('producers' and 'consumers' connected via keywords) """</span>&nbsp;</span><span class="r"></span></p>
